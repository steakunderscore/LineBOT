...
#define MOTOR_DRLEFT1  PIO_DEFINE(PORT_D, 0)
#define MOTOR_DRLEFT2  PIO_DEFINE(PORT_D, 2)
#define MOTOR_DRRIGHT1 PIO_DEFINE(PORT_D, 1)
#define MOTOR_DRRIGHT2 PIO_DEFINE(PORT_D, 3)
